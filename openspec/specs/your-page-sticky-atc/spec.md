# your-page-sticky-atc Specification

## Purpose

Defines the behavior of a mobile-only sticky "add to cart" helper button that renders on `your-` prefixed pages, guiding shoppers to the main PDP add-to-cart control and handing off to the existing sticky ATC.
