...
Defines store-specific behavior of the Rebuy Smart Cart template override (`snippets/rebuy-cart-template.liquid`), which replaces the theme's native cart drawer as the primary cart surface.
